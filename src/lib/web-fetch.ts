...
const DEFAULT_INCLUDE_DOMAINS: string[] | undefined = undefined;

const PREFERRED_CN_DOMAINS = new Set([
  ...
  "gov.cn", "moe.gov.cn", "stats.gov.cn",
]);

const ACCESSIBLE_FOREIGN_DOMAINS = new Set([
  "wikipedia.org", "bbc.com", "reuters.com", "bloomberg.com",
  "cn.reuters.com", "nature.com", "sciencedirect.com",
  "arxiv.org", "medium.com", "github.com",
]);
