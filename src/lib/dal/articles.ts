...
import type { ArticleListItem, ArticleDetail, ArticleStats, VideoChapter, TranscriptSegment } from "@/lib/types";
...
export async function getArticle(id: string): Promise<ArticleDetail | undefined> {
  ...
  return {
    ...
    chapters: (row.chapters as VideoChapter[] | null) ?? undefined,
    transcript: (row.transcript as TranscriptSegment[] | null) ?? undefined,
  };
}
