...
const categoryColors: Record<SkillCategory, string> = {
  info_perception: "bg-sky-100 text-sky-700 dark:bg-sky-900/30 dark:text-sky-400",
  info_processing: "bg-purple-100 text-purple-700 dark:bg-purple-950/50 dark:text-purple-400",
  system_interop: "bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400",
  ...
  multimodal: "bg-pink-100 text-pink-700 dark:bg-pink-900/30 dark:text-pink-400",
