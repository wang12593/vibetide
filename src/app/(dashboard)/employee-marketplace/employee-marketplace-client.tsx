...
export function EmployeeMarketplaceClient({
  ...
  return (
    <div className="max-w-[1400px] mx-auto">
      <PageHeader
        title="数字员工"
        description="浏览、管理和创建你的AI智能数字员工团队"
      />
      ...
      {loading && (
        <div className="flex flex-col items-center justify-center py-20 gap-3">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">正在加载数字员工数据...</p>
        </div>
      )}
      ...
      <ConfirmDialog
        ...
        description={
          deleteError
            ? deleteError
            : `确认删除数字员工「${deleteTarget?.nickname}」？删除后该数字员工的所有技能绑定将一并移除，此操作不可恢复。`
        }
        confirmText="删除"
        cancelText="取消"
        variant="danger"
