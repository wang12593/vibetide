          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-4 text-xs text-muted-foreground/70">
              ...
              <span className="flex items-center gap-1">
                ...
                {kb.boundEmployeeCount} 名数字员工已绑定
              </span>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="space-y-6 max-w-[640px]">
      ...
      <div className="bg-card border border-red-200 dark:border-red-900/40 rounded-xl p-5 space-y-3">
        ...
        <p className="text-xs text-muted-foreground">
          删除知识库会同时清理所有文档、向量和数字员工绑定关系。此操作不可恢复。
        </p>
        <Button
          variant="outline"
      ...
      <ConfirmDialog
        ...
        title="确认删除知识库？"
        description={`将同时删除 ${kb.documentCount} 个文档、${kb.chunkCount} 个 chunks，并解除 ${kb.boundEmployeeCount} 名数字员工的绑定。此操作不可恢复。`}
        confirmText="确认删除"
        variant="danger"
        loading={deleting}
