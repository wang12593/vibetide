...
// 当前阶段从环境变量读取推送目标，见 src/lib/cms/article-mapper/index.ts
// 环境变量未配置时使用默认值
const DEFAULT_TARGET = { siteId: 81, appId: 1768, catalogId: 10210 };
...
export function CmsMappingClient({ cmsCatalogs, recentLogs }: Props) {
  ...
  return (
    <div>
      <PageHeader
        title="CMS 栏目映射"
        description="查看本地同步的技术保障部 CMS 栏目树与同步日志。"
        actions={
      ...
      <GlassCard variant="secondary" padding="sm" className="mb-4">
        <div className="text-xs text-muted-foreground">
          ...
          <span className="font-mono text-foreground">
            {" "}
            siteId={DEFAULT_TARGET.siteId} · appId={DEFAULT_TARGET.appId} · catalogId=
            {DEFAULT_TARGET.catalogId}
          </span>
