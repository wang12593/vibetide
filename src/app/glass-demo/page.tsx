  ...
  return (
    <div className={s.root}>
      ...
      <header className="relative z-10 max-w-7xl mx-auto px-6 pt-6">
        <div className={`${s.glass} flex items-center justify-between px-5 py-3`}>
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold">智能协作空间 · Glass Demo</span>
          </div>
          <div className="flex items-center gap-2">
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 pt-16 pb-10 text-center">
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-red-500/10 border border-red-400/20 backdrop-blur-md mb-6">
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 pb-16">
        <div className="flex items-end justify-between mb-4">
          <div>
            ...
            <p className={`${s.muted} text-sm`}>每位数字员工都有独特的发型、装备与岗位动画</p>
          </div>
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
          ...
          <div className={`${s.glass} p-6`}>
            ...
            <p className={`${s.muted} text-xs mb-4`}>AI 会为你挑选合适的数字员工</p>
