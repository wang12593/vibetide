...
export const TOC_ITEMS: TocItem[] = [
  ...
  { id: "ch3-binding", title: "数字员工绑定机制", level: 2 },
...
export const ARCH_LAYERS: ArchLayer[] = [
  ...
  },
  {
    ...
    modules: [
      ...
      { name: "Jina Embeddings" }, { name: "BullMQ 任务队列" },
...
export const COGNITIVE_LOOP_STEPS: LoopStep[] = [
  ...
  { id: "dag", num: "③", title: "动态流程创建", description: "DAG拆解 → 数字员工分配 → 并行调度", color: "#10b981" },
...
export const PROMPT_LAYERS: PromptLayer[] = [
  { layer: 1, name: "身份层", content: "数字员工姓名、角色、性格特征、工作风格", dynamicLevel: "静态" },
...
export const TECH_STACK: TechItem[] = [
  ...
  { name: "BullMQ", category: "任务调度", reason: "Redis 队列、自带重试、并发控制" },
...
export const KNOWLEDGE_PIPELINE: PipelineStep[] = [
  ...
  { icon: "Link", title: "数字员工绑定", detail: "多对多 权限隔离" },
