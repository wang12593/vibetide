...
export async function updateKnowledgeBase(
  ...
  if (kb) assertContentOwnership(kb, user.id);
...
export async function addKnowledgeItem(
  ...
  try {
    ...
    await dispatch("kb/document-created", { knowledgeBaseId: kbId, organizationId: orgId });
...
export async function updateKnowledgeItem(
  ...
  if (input.content !== undefined) {
    ...
    await dispatch("kb/document-created" as any, { knowledgeBaseId: item.knowledgeBaseId, organizationId: orgId });
  }
...
export async function reindexKnowledgeBase(kbId: string) {
  ...
  await dispatch("kb/reindex-requested", { knowledgeBaseId: kbId, organizationId: orgId });
