...
export async function addSample(
  ...
  try {
    ...
    await dispatch("research/bridge.backfill.trigger" as any, { sampleId: row.id, topicId: data.topicId, operation: "created" });
...
export async function updateSample(
  ...
  try {
    ...
    await dispatch("research/bridge.backfill.trigger" as any, { sampleId: data.id, topicId: sample.topicId, operation: "updated" });
